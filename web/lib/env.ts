...
export const env = {
  apkUrl: (!rawApkUrl || rawApkUrl.includes('android-v1.0.1'))
    ? 'https://github.com/dark9th5/Loomora/releases/download/android-v1.0.2/app-release.apk'
    : rawApkUrl,
  playUrl: process.env.NEXT_PUBLIC_PLAY_URL || 'https://play.google.com/store/apps/details?id=com.loomora',
  latestVersion: (!rawVersion || rawVersion === '1.0.1') ? '1.0.2' : rawVersion,
