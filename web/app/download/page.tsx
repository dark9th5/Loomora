        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Internal APK compiled directly from the current source tree, with offline RNNoise filtering and selectable recording sources. Requires zero Google Play services for core local audio recording.
            </p>
